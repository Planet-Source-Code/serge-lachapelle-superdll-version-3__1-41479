...
' Switch (condition_1, truepart_value_1, condition_2, truepart_value_2, ...)
' Choose (index_de_1_a_nombre_de_choix, choice_1, choice_2, choice_3, ...)
' RTrim (String_Name)   LTrim (String_Name)   Trim (String_Name)
' Shell (Path&FileName, WindowStyle)
